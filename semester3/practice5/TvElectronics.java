...
public class TvElectronics {
  ...
  // zu diesem Zeitpunkt hat die TimeShift-Aufnahme begonnen (in Sekunden seit 1.1.1970)
  ...
  public void setChannel(String channel, boolean forPiP) throws Exception {
    ...
    Settings.set(forPiP ? "mainChannel" : "pipChannel", channel);
